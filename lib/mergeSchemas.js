    ...
    _.each(obj, function(val, key) {
      ...
      if(key.match(/\$ref/)) {
        ...
        if(path.existsSync(filePath)) {
          // TODO: Should the sub schema have the parent key?
          return parentObj[parentKey] = itterate(JSON.parse(fs.readFileSync(filePath, 'binary'))[parentKey], parentKey, parentObj);
